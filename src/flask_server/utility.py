...
def get_str_message_from_confidence_score(score) -> str:
    """
    Converts score to string. Includes a forced float conversion 
    to prevent crashes if the model returns a string or object.
    """
    try:
        # If score is a dict like {'label': 0.8}, extract the value
        ...
        return f"Unknown Result (Raw: {score})"
    ...
    if val >= 0.90:
        ...
        return "Almost certainly human-generated"
